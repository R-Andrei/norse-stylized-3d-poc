...
Texture2D<float4> _FoamPersistentStateRemapRead;
...
StructuredBuffer<FoamSourceEventData> _FoamSourceEvents;
...
// to these values in lockstep; the current normalized mapping remains active.
...
float4 _FoamTopologyTransitionGridDescriptorContract;
float4 _FoamTopologyTransitionGridDescriptorSpacing;
float4 _FoamTopologyTransitionGridDescriptorLateral;
float4 _FoamTopologyTransitionGridDescriptorLongitudinal;
float4 _FoamTopologyTransitionGridDescriptorExtent;
...
int _FoamBulkTransportIntegerShift;
...
int _FoamSourceEventDebugComponentMode;
int _FoamTransportMetricsEnabled;
int _FoamPersistentStateRemapEnabled;
int _FoamMaterialContract;
...
float _FoamTransportReconstructionCourant;
float _FoamBulkTransportPhaseCells;
float _FoamBulkTransportSpeed;
...
float _FoamTime;
float _FoamTopologyEvaluationTime;
float _FoamSeed;
...
float _FoamShoreWaveSpacingScale;
...
float _FoamShoreWaveProfileEvolutionStrength;
float _FoamShoreWaveProfileEvolutionDuration;
...
float _FoamInjectionUsesMetricLateral;
float _FoamInjectionLateralMetres;
...
float _FoamInjectionSegmentStartLateralMetres;
...
float _FoamInjectionSegmentEndLateralMetres;
