    ...
    internal sealed class StylizedRiverEditor : UnityEditor.Editor
    {
        ...
        private void DrawFoam()
        {
            ...
            EditorGUILayout.PropertyField(
                ...
                new GUIContent(
                    "Foam Preset",
                    "Applies one coherent stylized Foam personality using the six visual controls. Custom preserves the current values, and presets do not change the dedicated Major Support shape or cadence settings."));
            if (EditorGUI.EndChangeCheck())
            {
                serializedObject.ApplyModifiedProperties();
            ...
            EditorGUILayout.PropertyField(
                ...
                new GUIContent(
                    "Network Evolution",
                    "Controls the intensity of asynchronous topology growth, decay, drift, and local rate variation. It does not set the compute cadence."));
            EditorGUILayout.PropertyField(
            ...
            EditorGUILayout.PropertyField(
                ...
                new GUIContent(
                    "Major Support Size",
                    "Controls the physical scale of individual Major Support regions independently from their amount. The low end reaches small hosts. Each nucleus chooses among compact raft, bean/crescent, long strip/ribbon, hook/wedge, and compound raft shapes generated by one shared variable-width spine kernel; beans and strips are intentionally most common."));
            EditorGUILayout.PropertyField(
